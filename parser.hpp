...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // binding
      char dummy8[sizeof (VarBindingsAST*)];
      ...
      // vardefs
      char dummy13[sizeof (std::vector<VarBindingsAST*>)];
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_binding: // binding
        value.move< VarBindingsAST* > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_vardefs: // vardefs
        value.move< std::vector<VarBindingsAST*> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, VarBindingsAST*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const VarBindingsAST*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<VarBindingsAST*>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<VarBindingsAST*>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_binding: // binding
        value.template destroy< VarBindingsAST* > ();
        break;
      ...
      case symbol_kind::S_vardefs: // vardefs
        value.template destroy< std::vector<VarBindingsAST*> > ();
        break;
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_binding: // binding
        value.copy< VarBindingsAST* > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_vardefs: // vardefs
        value.copy< std::vector<VarBindingsAST*> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_binding: // binding
        value.move< VarBindingsAST* > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_vardefs: // vardefs
        value.move< std::vector<VarBindingsAST*> > (YY_MOVE (s.value));
        break;
